...
const byte keycode[MATRIX_SIZE] = {97, 113, 119, 101, 114, 116,              // Esc  1  2  3  4  5 
                                   113, 119, 101, 114, 116, 97,        // Tab  q  w  e  r  t
                                   97, 113, 119, 101, 114, 116,         // Caps_Lock  a  s  d  f  g
                                   113, 119, 101, 114, 116, 97,          // Left_Shift  z  x  c  v  b 
                                   97, 113, 119, 101, 114, 116,           // Left_Control  Win  `  -  +  Right_Alt
                                   113, 119, 101, 97,                      // Alt  Right_Ctrl  Key_Reload  Function_Key
                                   97, 97,                             // Space  Menu
                                   97, 97};                               // Left_click  Right_click

                                   
const byte fnkeycode[MATRIX_SIZE] = {97, 97, 97, 97, 97, 97,              // Esc  1  2  3  4  5 
                                   97, 97, 97, 97, 97, 97,        // Tab  q  w  e  r  t
                                   97, 97, 97, 97, 97, 97,         // Caps_Lock  a  s  d  f  g
                                   97, 97, 97, 97, 97, 97,          // Left_Shift  z  x  c  v  b 
                                   97, 97, 97, 97, 97, 97,           // Left_Control  Win  `  -  +  Right_Alt
                                   97, 97, 97, 97,                      // Alt  Right_Ctrl  Key_Reload  Function_Key
                                   97, 97,                             // Space  Menu
                                   97, 97};                               // Left_click  Right_click
...
//    if(curMillis - sleepCounter > 30000){
      ...
      if (curBuffer[i] == 0){
        ...
        if (FN_KEY == true){
          ...
          if(curBuffer[36] == 0){
            ...
            bleKeyboard.press(fnkeycode[i]);
              }
            }
        }
      else{
          bleKeyboard.release(keycode[i]);
          bleKeyboard.release(fnkeycode[i]);
          bleMouse.release();
        }
    }
...
//
//void write_MacAdress(){
//
//  bleKeyboard.write(WiFi.macAddress());
//
//}
